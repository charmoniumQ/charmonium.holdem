...
2. Pull the codebase and branch ``fix-${issue_number}`` off of master,
   ...
   `issue tracker`_. Ensure the test suite works on your machine.
    ...
    .. code-block:: console
        ...
        $ poetry shell
        (charmonium.holdem-venv) $ poetry install
        (charmonium.holdem-venv) $ ./scripts/test.sh
        (charmonium.holdem-venv) $ ./scripts/docs.sh # if desired
...
.. _`issue tracker`: https://github.com/charmoniumQ/charmonium.holdem/issues
